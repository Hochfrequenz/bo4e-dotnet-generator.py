...
//    using BO4EDotNet;
//
//    var ausschreibungsdetail = Ausschreibungsdetail.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Ausschreibungsdetail
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("istLastgangVorhanden")]
        public bool? IstLastgangVorhanden { get; set; }
        ...
        /// </summary>
        [JsonProperty("lieferzeitraum")]
        public Zeitraum Lieferzeitraum { get; set; }

        /// <summary>
        /// Die Adresse an der die Marktlokation sich befindet
        /// </summary>
        [JsonProperty("marktlokationsadresse")]
        public Adresse Marktlokationsadresse { get; set; }

        /// <summary>
        /// Bezeichnung für die Lokation, z.B. 'Zentraler Einkauf, Hamburg'
        /// </summary>
        [JsonProperty("marktlokationsbezeichnung")]
        public string Marktlokationsbezeichnung { get; set; }
    ...
    public partial class Ausschreibungsdetail
    {
        public static Ausschreibungsdetail FromJson(string json) => JsonConvert.DeserializeObject<Ausschreibungsdetail>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Ausschreibungsdetail self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
