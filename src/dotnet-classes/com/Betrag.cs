...
//    using BO4EDotNet;
//
//    var betrag = Betrag.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    public partial class Betrag
    {
        public static Betrag FromJson(string json) => JsonConvert.DeserializeObject<Betrag>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Betrag self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
