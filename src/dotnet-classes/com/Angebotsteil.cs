...
//    using BO4EDotNet;
//
//    var angebotsteil = Angebotsteil.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Angebotsteil
    {
        /// <summary>
        ...
        /// Ausschreibung
        /// </summary>
        [JsonProperty("anfrageSubreferenz")]
        ...
        /// </summary>
        [JsonProperty("gesamtkostenangebotsteil")]
        ...
        /// </summary>
        [JsonProperty("gesamtmengeangebotsteil")]
        public Menge Gesamtmengeangebotsteil { get; set; }

        /// <summary>
        /// Summe der Verbräuche aller in diesem Angebotsteil eingeschlossenen Lieferstellen
        /// </summary>
        [JsonProperty("lieferstellenangebotsteil")]
        public Marktlokation[] Lieferstellenangebotsteil { get; set; }
        ...
        public Angebotsposition[] Positionen { get; set; }
    ...
    public partial class Angebotsteil
    {
        public static Angebotsteil FromJson(string json) => JsonConvert.DeserializeObject<Angebotsteil>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Angebotsteil self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
