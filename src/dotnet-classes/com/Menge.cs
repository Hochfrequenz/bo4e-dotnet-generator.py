...
//    using BO4EDotNet;
//
//    var menge = Menge.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    public partial class Menge
    {
        public static Menge FromJson(string json) => JsonConvert.DeserializeObject<Menge>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Menge self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
