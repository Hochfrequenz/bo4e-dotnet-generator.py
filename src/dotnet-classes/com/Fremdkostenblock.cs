...
//    using BO4EDotNet;
//
//    var fremdkostenblock = Fremdkostenblock.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    public partial class Fremdkostenblock
    {
        ...
        public Fremdkostenposition[] Kostenpositionen { get; set; }
    ...
    public partial class Fremdkostenblock
    {
        public static Fremdkostenblock FromJson(string json) => JsonConvert.DeserializeObject<Fremdkostenblock>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Fremdkostenblock self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
