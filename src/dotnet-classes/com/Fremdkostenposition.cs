...
//    using BO4EDotNet;
//
//    var fremdkostenposition = Fremdkostenposition.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Fremdkostenposition
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("betragKostenposition")]
        ...
        /// Regelzone TenneT
        /// </summary>
        [JsonProperty("gebietcodeEic")]
        public string GebietcodeEic { get; set; }

        /// <summary>
        /// Link zum veröffentlichten Preisblatt
        /// </summary>
        [JsonProperty("linkPreisblatt")]
        public string LinkPreisblatt { get; set; }

        /// <summary>
        /// Die Codenummer (z.B. BDEW-Codenummer) des Marktpartners, der die Preise festlegt / die
        /// Kosten in Rechnung stellt
        /// </summary>
        [JsonProperty("marktpartnercode")]
        public string Marktpartnercode { get; set; }

        /// <summary>
        /// Der Name des Marktpartners, der die Preise festlegt, bzw. die Kosten in Rechnung stellt
        /// </summary>
        [JsonProperty("marktpartnername")]
        public string Marktpartnername { get; set; }
    ...
    public partial class Fremdkostenposition
    {
        public static Fremdkostenposition FromJson(string json) => JsonConvert.DeserializeObject<Fremdkostenposition>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Fremdkostenposition self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
