...
//    using BO4EDotNet;
//
//    var preisgarantie = Preisgarantie.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    public partial class Preisgarantie
    {
        public static Preisgarantie FromJson(string json) => JsonConvert.DeserializeObject<Preisgarantie>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Preisgarantie self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
