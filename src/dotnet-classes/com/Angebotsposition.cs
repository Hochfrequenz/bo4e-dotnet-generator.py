...
//    using BO4EDotNet;
//
//    var angebotsposition = Angebotsposition.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Angebotsposition
    {
        /// <summary>
    ...
    public partial class Angebotsposition
    {
        public static Angebotsposition FromJson(string json) => JsonConvert.DeserializeObject<Angebotsposition>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Angebotsposition self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
