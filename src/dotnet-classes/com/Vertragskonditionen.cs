...
//    using BO4EDotNet;
//
//    var vertragskonditionen = Vertragskonditionen.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Vertragskonditionen
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("abschlagszyklus")]
        public Zeitraum Abschlagszyklus { get; set; }

        /// <summary>
        /// Anzahl der vereinbarten Abschläge pro Jahr, z.B. 12
        /// </summary>
        [JsonProperty("anzahlAbschlaege")]
        public double? AnzahlAbschlaege { get; set; }
        ...
        /// angegebene Zeit
        /// </summary>
        [JsonProperty("vertragsverlaengerung")]
    ...
    public partial class Vertragskonditionen
    {
        public static Vertragskonditionen FromJson(string json) => JsonConvert.DeserializeObject<Vertragskonditionen>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Vertragskonditionen self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
