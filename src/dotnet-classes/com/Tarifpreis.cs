...
//    using BO4EDotNet;
//
//    var tarifpreis = Tarifpreis.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    public partial class Tarifpreis
    {
        public static Tarifpreis FromJson(string json) => JsonConvert.DeserializeObject<Tarifpreis>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Tarifpreis self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
