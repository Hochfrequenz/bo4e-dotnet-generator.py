...
//    using BO4EDotNet;
//
//    var rechnungsposition = Rechnungsposition.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    public partial class Rechnungsposition
    {
        ...
        /// </summary>
        [JsonProperty("positionsMenge")]
        public Menge PositionsMenge { get; set; }

        /// <summary>
        /// Fortlaufende Nummer für die Rechnungsposition
        /// </summary>
        [JsonProperty("positionsnummer")]
        public long? Positionsnummer { get; set; }
    ...
    public partial class Rechnungsposition
    {
        public static Rechnungsposition FromJson(string json) => JsonConvert.DeserializeObject<Rechnungsposition>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Rechnungsposition self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
