...
//    using BO4EDotNet;
//
//    var angebotsvariante = Angebotsvariante.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Angebotsvariante
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("teile")]
        public Angebotsteil[] Teile { get; set; }
    ...
    public partial class Angebotsvariante
    {
        public static Angebotsvariante FromJson(string json) => JsonConvert.DeserializeObject<Angebotsvariante>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Angebotsvariante self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
    ...
    internal static class Converter
    {
        public static readonly JsonSerializerSettings Settings = new JsonSerializerSettings
        {
            ...
            Converters =
            {
                AngebotsstatusConverter.Singleton,
    ...
    internal class AngebotsstatusConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(Angebotsstatus) || t == typeof(Angebotsstatus?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case "ABGELEHNT":
                    return Angebotsstatus.Abgelehnt;
                case "AUSSTEHEND":
                    return Angebotsstatus.Ausstehend;
                case "BEAUFTRAGT":
                    return Angebotsstatus.Beauftragt;
                case "ERLEDIGT":
                    return Angebotsstatus.Erledigt;
                case "KONZEPTION":
                    return Angebotsstatus.Konzeption;
                case "NACHGEFASST":
                    return Angebotsstatus.Nachgefasst;
                case "UNGUELTIG":
                    return Angebotsstatus.Ungueltig;
                case "UNVERBINDLICH":
                    return Angebotsstatus.Unverbindlich;
                case "VERBINDLICH":
                    return Angebotsstatus.Verbindlich;
            }
            throw new Exception("Cannot unmarshal type Angebotsstatus");
        }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            var value = (Angebotsstatus)untypedValue;
            switch (value)
            {
                case Angebotsstatus.Abgelehnt:
                    serializer.Serialize(writer, "ABGELEHNT");
                    return;
                case Angebotsstatus.Ausstehend:
                    serializer.Serialize(writer, "AUSSTEHEND");
                    return;
                case Angebotsstatus.Beauftragt:
                    serializer.Serialize(writer, "BEAUFTRAGT");
                    return;
                case Angebotsstatus.Erledigt:
                    serializer.Serialize(writer, "ERLEDIGT");
                    return;
                case Angebotsstatus.Konzeption:
                    serializer.Serialize(writer, "KONZEPTION");
                    return;
                case Angebotsstatus.Nachgefasst:
                    serializer.Serialize(writer, "NACHGEFASST");
                    return;
                case Angebotsstatus.Ungueltig:
                    serializer.Serialize(writer, "UNGUELTIG");
                    return;
                case Angebotsstatus.Unverbindlich:
                    serializer.Serialize(writer, "UNVERBINDLICH");
                    return;
                case Angebotsstatus.Verbindlich:
                    serializer.Serialize(writer, "VERBINDLICH");
                    return;
            }
            throw new Exception("Cannot marshal type Angebotsstatus");
        }

        public static readonly AngebotsstatusConverter Singleton = new AngebotsstatusConverter();
    }
