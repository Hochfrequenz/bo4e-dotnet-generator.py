...
//    using BO4EDotNet;
//
//    var steuerbetrag = Steuerbetrag.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Steuerbetrag
    {
        /// <summary>
    ...
    public partial class Steuerbetrag
    {
        public static Steuerbetrag FromJson(string json) => JsonConvert.DeserializeObject<Steuerbetrag>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Steuerbetrag self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
