...
//    using BO4EDotNet;
//
//    var preisblattHardware = PreisblattHardware.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class PreisblattHardware
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("basisgeraet")]
        public Geraet Basisgeraet { get; set; }
        ...
        /// </summary>
        [JsonProperty("inklusiveGeraete")]
        public Geraet[] InklusiveGeraete { get; set; }

        /// <summary>
        /// Die Preise gelten für Messlokationen in der angebebenen Netzebene
        /// </summary>
        [JsonProperty("messebene")]
    ...
    public partial class PreisblattHardware
    {
        public static PreisblattHardware FromJson(string json) => JsonConvert.DeserializeObject<PreisblattHardware>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this PreisblattHardware self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
