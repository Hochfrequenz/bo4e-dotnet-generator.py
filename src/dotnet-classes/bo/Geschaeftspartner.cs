...
//    using BO4EDotNet;
//
//    var geschaeftspartner = Geschaeftspartner.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Geschaeftspartner
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("individuelleAnrede")]
        public string IndividuelleAnrede { get; set; }

        /// <summary>
        /// Kontaktwege des Geschäftspartners
        /// </summary>
        [JsonProperty("kontaktwege")]
        public Kontaktweg[] Kontaktwege { get; set; }
        ...
        public string Organisationsname { get; set; }

        /// <summary>
        /// organisationsname: Optional[str] = None
        /// </summary>
        [JsonProperty("organisationstyp")]
        public Organisationstyp? Organisationstyp { get; set; }
    ...
    public partial class Geschaeftspartner
    {
        public static Geschaeftspartner FromJson(string json) => JsonConvert.DeserializeObject<Geschaeftspartner>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Geschaeftspartner self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
