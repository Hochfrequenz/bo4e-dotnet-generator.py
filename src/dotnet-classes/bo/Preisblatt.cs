...
//    using BO4EDotNet;
//
//    var preisblatt = Preisblatt.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Preisblatt
    {
        /// <summary>
    ...
    public partial class Preisblatt
    {
        public static Preisblatt FromJson(string json) => JsonConvert.DeserializeObject<Preisblatt>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Preisblatt self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
