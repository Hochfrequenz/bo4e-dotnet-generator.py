...
//    using BO4EDotNet;
//
//    var preisblattNetznutzung = PreisblattNetznutzung.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class PreisblattNetznutzung
    {
        /// <summary>
    ...
    public partial class PreisblattNetznutzung
    {
        public static PreisblattNetznutzung FromJson(string json) => JsonConvert.DeserializeObject<PreisblattNetznutzung>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this PreisblattNetznutzung self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
    ...
    internal static class Converter
    {
        public static readonly JsonSerializerSettings Settings = new JsonSerializerSettings
        {
            ...
            Converters =
            {
                ...
                KundengruppeConverter.Singleton,
    ...
    internal class KundengruppeConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(Kundengruppe) || t == typeof(Kundengruppe?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case "RLM":
                    return Kundengruppe.Rlm;
                case "RLM_KOMMUNAL":
                    return Kundengruppe.RlmKommunal;
                case "SLP_G_GBA":
                    return Kundengruppe.SlpGGba;
                case "SLP_G_GBD":
                    return Kundengruppe.SlpGGbd;
                case "SLP_G_GBH":
                    return Kundengruppe.SlpGGbh;
                case "SLP_G_GGA":
                    return Kundengruppe.SlpGGga;
                case "SLP_G_GGB":
                    return Kundengruppe.SlpGGgb;
                case "SLP_G_GHA":
                    return Kundengruppe.SlpGGha;
                case "SLP_G_GKO":
                    return Kundengruppe.SlpGGko;
                case "SLP_G_GMF":
                    return Kundengruppe.SlpGGmf;
                case "SLP_G_GMK":
                    return Kundengruppe.SlpGGmk;
                case "SLP_G_GPD":
                    return Kundengruppe.SlpGGpd;
                case "SLP_G_GWA":
                    return Kundengruppe.SlpGGwa;
                case "SLP_G_HEF":
                    return Kundengruppe.SlpGHef;
                case "SLP_G_HKO":
                    return Kundengruppe.SlpGHko;
                case "SLP_G_HMF":
                    return Kundengruppe.SlpGHmf;
                case "SLP_G_STANDARD":
                    return Kundengruppe.SlpGStandard;
                case "SLP_KOMMUNAL":
                    return Kundengruppe.SlpKommunal;
                case "SLP_S_EM":
                    return Kundengruppe.SlpSEm;
                case "SLP_S_G0":
                    return Kundengruppe.SlpSG0;
                case "SLP_S_G1":
                    return Kundengruppe.SlpSG1;
                case "SLP_S_G2":
                    return Kundengruppe.SlpSG2;
                case "SLP_S_G3":
                    return Kundengruppe.SlpSG3;
                case "SLP_S_G4":
                    return Kundengruppe.SlpSG4;
                case "SLP_S_G5":
                    return Kundengruppe.SlpSG5;
                case "SLP_S_G6":
                    return Kundengruppe.SlpSG6;
                case "SLP_S_G7":
                    return Kundengruppe.SlpSG7;
                case "SLP_S_H0":
                    return Kundengruppe.SlpSH0;
                case "SLP_S_HZ":
                    return Kundengruppe.SlpSHz;
                case "SLP_S_HZ_GEM":
                    return Kundengruppe.SlpSHzGem;
                case "SLP_S_L0":
                    return Kundengruppe.SlpSL0;
                case "SLP_S_L1":
                    return Kundengruppe.SlpSL1;
                case "SLP_S_L2":
                    return Kundengruppe.SlpSL2;
                case "SLP_S_SB":
                    return Kundengruppe.SlpSSb;
                case "SLP_S_WP":
                    return Kundengruppe.SlpSWp;
            }
            throw new Exception("Cannot unmarshal type Kundengruppe");
        }
