...
//    using BO4EDotNet;
//
//    var tarifinfo = Tarifinfo.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Tarifinfo
    {
        /// <summary>
    ...
    public partial class Tarifinfo
    {
        public static Tarifinfo FromJson(string json) => JsonConvert.DeserializeObject<Tarifinfo>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Tarifinfo self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
