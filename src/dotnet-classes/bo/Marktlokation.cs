...
//    using BO4EDotNet;
//
//    var marktlokation = Marktlokation.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Marktlokation
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("bilanzierungsgebiet")]
        ...
        /// Flurstück erfolgen.
        /// </summary>
        [JsonProperty("katasterinformation")]
        ...
        /// </summary>
        [JsonProperty("netzgebietsnr")]
        public string Netzgebietsnr { get; set; }

        /// <summary>
        /// Kundengruppen der Marktlokation
        /// </summary>
        [JsonProperty("regelzone")]
        ...
        [JsonProperty("verbrauchsmengen")]
        public Verbrauch[] Verbrauchsmengen { get; set; }

        /// <summary>
        /// für Gas. Code vom EIC, https://www.entsog.eu/data/data-portal/codes-list
        /// </summary>
        [JsonProperty("zaehlwerke")]
        public Zaehlwerk[] Zaehlwerke { get; set; }

        [JsonProperty("zaehlwerkeDerBeteiligtenMarktrolle")]
        public Zaehlwerk[] ZaehlwerkeDerBeteiligtenMarktrolle { get; set; }

        [JsonProperty("zugehoerigeMesslokation")]
        public Messlokationszuordnung ZugehoerigeMesslokation { get; set; }
    ...
    public partial class Marktlokation
    {
        public static Marktlokation FromJson(string json) => JsonConvert.DeserializeObject<Marktlokation>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Marktlokation self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
