...
//    using BO4EDotNet;
//
//    var vertrag = Vertrag.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    public partial class Vertrag
    {
        ...
        /// Beschreibung zum Vertrag
        /// </summary>
        [JsonProperty("vertragsteile")]
        public Vertragsteil[] Vertragsteile { get; set; }
    ...
    public partial class Vertrag
    {
        public static Vertrag FromJson(string json) => JsonConvert.DeserializeObject<Vertrag>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Vertrag self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
