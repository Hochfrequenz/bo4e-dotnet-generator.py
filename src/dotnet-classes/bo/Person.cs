...
namespace BO4EDotNet
{
    ...
    public partial class Person
    {
        ...
        /// </summary>
        [JsonProperty("zustaendigkeiten")]
        public Zustaendigkeit[] Zustaendigkeiten { get; set; }
    }
    ...
    public partial class Person
    {
        public static Person FromJson(string json) => JsonConvert.DeserializeObject<Person>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Person self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
