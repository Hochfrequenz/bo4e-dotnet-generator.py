...
//    using BO4EDotNet;
//
//    var preisblattKonzessionsabgabe = PreisblattKonzessionsabgabe.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class PreisblattKonzessionsabgabe
    {
        /// <summary>
    ...
    public partial class PreisblattKonzessionsabgabe
    {
        public static PreisblattKonzessionsabgabe FromJson(string json) => JsonConvert.DeserializeObject<PreisblattKonzessionsabgabe>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this PreisblattKonzessionsabgabe self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
    ...
    internal static class Converter
    {
        public static readonly JsonSerializerSettings Settings = new JsonSerializerSettings
        {
            ...
            Converters =
            {
                ...
                KundengruppeKaConverter.Singleton,
    ...
    internal class KundengruppeKaConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(KundengruppeKa) || t == typeof(KundengruppeKa?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case "G_KOWA_100000":
                    return KundengruppeKa.GKowa100000;
                case "G_KOWA_25000":
                    return KundengruppeKa.GKowa25000;
                case "G_KOWA_500000":
                    return KundengruppeKa.GKowa500000;
                case "G_KOWA_G_500000":
                    return KundengruppeKa.GKowaG500000;
                case "G_SONDERKUNDE":
                    return KundengruppeKa.GSonderkunde;
                case "G_TARIF_100000":
                    return KundengruppeKa.GTarif100000;
                case "G_TARIF_25000":
                    return KundengruppeKa.GTarif25000;
                case "G_TARIF_500000":
                    return KundengruppeKa.GTarif500000;
                case "G_TARIF_G_500000":
                    return KundengruppeKa.GTarifG500000;
                case "SONDER_KAS":
                    return KundengruppeKa.SonderKas;
                case "SONDER_SAS":
                    return KundengruppeKa.SonderSas;
                case "SONDER_TAS":
                    return KundengruppeKa.SonderTas;
                case "SONDER_TKS":
                    return KundengruppeKa.SonderTks;
                case "SONDER_TSS":
                    return KundengruppeKa.SonderTss;
                case "S_SCHWACHLAST":
                    return KundengruppeKa.SSchwachlast;
                case "S_SONDERKUNDE":
                    return KundengruppeKa.SSonderkunde;
                case "S_TARIF_100000":
                    return KundengruppeKa.STarif100000;
                case "S_TARIF_25000":
                    return KundengruppeKa.STarif25000;
                case "S_TARIF_500000":
                    return KundengruppeKa.STarif500000;
                case "S_TARIF_G_500000":
                    return KundengruppeKa.STarifG500000;
            }
            throw new Exception("Cannot unmarshal type KundengruppeKa");
        }
