...
//    using BO4EDotNet;
//
//    var tarif = Tarif.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    public partial class Tarif
    {
        ...
        public AufAbschlagRegional[] TarifAufAbschlaege { get; set; }
        ...
        public TarifpreispositionProOrt[] Tarifpreise { get; set; }
    ...
    public partial class Tarif
    {
        public static Tarif FromJson(string json) => JsonConvert.DeserializeObject<Tarif>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Tarif self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
