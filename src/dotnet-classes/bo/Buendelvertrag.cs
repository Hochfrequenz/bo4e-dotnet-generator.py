...
//    using BO4EDotNet;
//
//    var buendelvertrag = Buendelvertrag.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Buendelvertrag
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("einzelvertraege")]
        public Vertrag[] Einzelvertraege { get; set; }
        ...
        /// </summary>
        [JsonProperty("unterzeichnervp1")]
        public Unterschrift[] Unterzeichnervp1 { get; set; }

        /// <summary>
        /// Unterzeichner des Vertragspartners2
        /// </summary>
        [JsonProperty("unterzeichnervp2")]
        public Unterschrift[] Unterzeichnervp2 { get; set; }
    ...
    public partial class Buendelvertrag
    {
        public static Buendelvertrag FromJson(string json) => JsonConvert.DeserializeObject<Buendelvertrag>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Buendelvertrag self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
    ...
    internal static class Converter
    {
        public static readonly JsonSerializerSettings Settings = new JsonSerializerSettings
        {
            ...
            Converters =
            {
                ...
                VertragsartConverter.Singleton,
                ...
                VertragsstatusConverter.Singleton,
    ...
    internal class VertragsartConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(Vertragsart) || t == typeof(Vertragsart?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                case "BILANZIERUNGSVERTRAG":
                    return Vertragsart.Bilanzierungsvertrag;
                case "BUENDELVERTRAG":
                    return Vertragsart.Buendelvertrag;
                case "ENERGIELIEFERVERTRAG":
                    return Vertragsart.Energieliefervertrag;
                case "MESSSTELLENBETRIEBSVERTRAG":
                    return Vertragsart.Messstellenbetriebsvertrag;
                case "NETZNUTZUNGSVERTRAG":
                    return Vertragsart.Netznutzungsvertrag;
            }
            throw new Exception("Cannot unmarshal type Vertragsart");
        }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            var value = (Vertragsart)untypedValue;
            switch (value)
            {
                case Vertragsart.Bilanzierungsvertrag:
                    serializer.Serialize(writer, "BILANZIERUNGSVERTRAG");
                    return;
                case Vertragsart.Buendelvertrag:
                    serializer.Serialize(writer, "BUENDELVERTRAG");
                    return;
                case Vertragsart.Energieliefervertrag:
                    serializer.Serialize(writer, "ENERGIELIEFERVERTRAG");
                    return;
                case Vertragsart.Messstellenbetriebsvertrag:
                    serializer.Serialize(writer, "MESSSTELLENBETRIEBSVERTRAG");
                    return;
                case Vertragsart.Netznutzungsvertrag:
                    serializer.Serialize(writer, "NETZNUTZUNGSVERTRAG");
                    return;
            }
            throw new Exception("Cannot marshal type Vertragsart");
        }

        public static readonly VertragsartConverter Singleton = new VertragsartConverter();
    }
    ...
    internal class VertragsstatusConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(Vertragsstatus) || t == typeof(Vertragsstatus?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case "ABGELEHNT":
                    return Vertragsstatus.Abgelehnt;
                case "AKTIV":
                    return Vertragsstatus.Aktiv;
                case "ANGENOMMEN":
                    return Vertragsstatus.Angenommen;
                case "BEENDET":
                    return Vertragsstatus.Beendet;
                case "GEKUENDIGT":
                    return Vertragsstatus.Gekuendigt;
                case "IN_ARBEIT":
                    return Vertragsstatus.InArbeit;
                case "STORNIERT":
                    return Vertragsstatus.Storniert;
                case "UEBERMITTELT":
                    return Vertragsstatus.Uebermittelt;
                case "WIDERRUFEN":
                    return Vertragsstatus.Widerrufen;
            }
            throw new Exception("Cannot unmarshal type Vertragsstatus");
        }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            var value = (Vertragsstatus)untypedValue;
            switch (value)
            {
                case Vertragsstatus.Abgelehnt:
                    serializer.Serialize(writer, "ABGELEHNT");
                    return;
                case Vertragsstatus.Aktiv:
                    serializer.Serialize(writer, "AKTIV");
                    return;
                case Vertragsstatus.Angenommen:
                    serializer.Serialize(writer, "ANGENOMMEN");
                    return;
                case Vertragsstatus.Beendet:
                    serializer.Serialize(writer, "BEENDET");
                    return;
                case Vertragsstatus.Gekuendigt:
                    serializer.Serialize(writer, "GEKUENDIGT");
                    return;
                case Vertragsstatus.InArbeit:
                    serializer.Serialize(writer, "IN_ARBEIT");
                    return;
                case Vertragsstatus.Storniert:
                    serializer.Serialize(writer, "STORNIERT");
                    return;
                case Vertragsstatus.Uebermittelt:
                    serializer.Serialize(writer, "UEBERMITTELT");
                    return;
                case Vertragsstatus.Widerrufen:
                    serializer.Serialize(writer, "WIDERRUFEN");
                    return;
            }
            throw new Exception("Cannot marshal type Vertragsstatus");
        }

        public static readonly VertragsstatusConverter Singleton = new VertragsstatusConverter();
    }
}
