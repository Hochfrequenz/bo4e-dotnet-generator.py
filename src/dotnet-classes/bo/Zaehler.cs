...
//    using BO4EDotNet;
//
//    var zaehler = Zaehler.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    public partial class Zaehler
    {
        ...
        /// </summary>
        [JsonProperty("befestigungsart")]
        public Befestigungsart? Befestigungsart { get; set; }

        /// <summary>
        /// Zählerkonstante auf dem Zähler
        /// </summary>
        [JsonProperty("eichungBis")]
        public DateTimeOffset? EichungBis { get; set; }

        /// <summary>
        /// Größe des Zählers
        /// </summary>
        [JsonProperty("geraete")]
        public Geraet[] Geraete { get; set; }

        /// <summary>
        /// Der Hersteller des Zählers
        /// </summary>
        [JsonProperty("istFernschaltbar")]
        public bool? IstFernschaltbar { get; set; }

        /// <summary>
        /// Bis zu diesem Datum (exklusiv) ist der Zähler geeicht.
        /// </summary>
        [JsonProperty("letzteEichung")]
        public DateTimeOffset? LetzteEichung { get; set; }

        /// <summary>
        /// Fernschaltung
        /// </summary>
        [JsonProperty("messwerterfassung")]
        ...
        /// Strom oder Gas
        /// </summary>
        [JsonProperty("zaehlerauspraegung")]
        public Zaehlerauspraegung? Zaehlerauspraegung { get; set; }

        /// <summary>
        /// Befestigungsart
        /// </summary>
        [JsonProperty("zaehlergroesse")]
        public Zaehlergroesse? Zaehlergroesse { get; set; }

        /// <summary>
        /// Der Hersteller des Zählers
        /// </summary>
        [JsonProperty("zaehlerhersteller")]
        public Geschaeftspartner Zaehlerhersteller { get; set; }

        /// <summary>
        /// Spezifikation bezüglich unterstützter Tarif
        /// </summary>
        [JsonProperty("zaehlerkonstante")]
        public double? Zaehlerkonstante { get; set; }
    ...
    public partial class Zaehler
    {
        public static Zaehler FromJson(string json) => JsonConvert.DeserializeObject<Zaehler>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Zaehler self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
