...
//    using BO4EDotNet;
//
//    var kosten = Kosten.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    public partial class Kosten
    {
        ...
        /// Steuern etc
        /// </summary>
        [JsonProperty("kostenbloecke")]
        public Kostenblock[] Kostenbloecke { get; set; }

        /// <summary>
        /// Klasse der Kosten, beispielsweise Fremdkosten
        /// </summary>
        [JsonProperty("kostenklasse")]
        public Kostenklasse? Kostenklasse { get; set; }

        /// <summary>
        /// Die Gesamtsumme über alle Kostenblöcke und -positionen
        /// </summary>
        [JsonProperty("summeKosten")]
        public Betrag[] SummeKosten { get; set; }
    ...
    public partial class Kosten
    {
        public static Kosten FromJson(string json) => JsonConvert.DeserializeObject<Kosten>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Kosten self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
    ...
    internal static class Converter
    {
        public static readonly JsonSerializerSettings Settings = new JsonSerializerSettings
        {
            ...
            Converters =
            {
                ...
                KostenklasseConverter.Singleton,
    ...
    internal class KostenklasseConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(Kostenklasse) || t == typeof(Kostenklasse?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case "BESCHAFFUNG":
                    return Kostenklasse.Beschaffung;
                case "ENERGIEVERSORGUNGSKOSTEN":
                    return Kostenklasse.Energieversorgungskosten;
                case "FREMDKOSTEN":
                    return Kostenklasse.Fremdkosten;
                case "MARGEN":
                    return Kostenklasse.Margen;
                case "SELBSTKOSTEN":
                    return Kostenklasse.Selbstkosten;
            }
            throw new Exception("Cannot unmarshal type Kostenklasse");
        }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            var value = (Kostenklasse)untypedValue;
            switch (value)
            {
                case Kostenklasse.Beschaffung:
                    serializer.Serialize(writer, "BESCHAFFUNG");
                    return;
                case Kostenklasse.Energieversorgungskosten:
                    serializer.Serialize(writer, "ENERGIEVERSORGUNGSKOSTEN");
                    return;
                case Kostenklasse.Fremdkosten:
                    serializer.Serialize(writer, "FREMDKOSTEN");
                    return;
                case Kostenklasse.Margen:
                    serializer.Serialize(writer, "MARGEN");
                    return;
                case Kostenklasse.Selbstkosten:
                    serializer.Serialize(writer, "SELBSTKOSTEN");
                    return;
            }
            throw new Exception("Cannot marshal type Kostenklasse");
        }

        public static readonly KostenklasseConverter Singleton = new KostenklasseConverter();
    }
}
