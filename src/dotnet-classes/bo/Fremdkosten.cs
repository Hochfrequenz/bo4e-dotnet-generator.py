...
//    using BO4EDotNet;
//
//    var fremdkosten = Fremdkosten.FromJson(jsonString);
...
namespace BO4EDotNet
{
    ...
    /// </summary>
    public partial class Fremdkosten
    {
        /// <summary>
        ...
        public Fremdkostenblock[] Kostenbloecke { get; set; }
    ...
    public partial class Fremdkosten
    {
        public static Fremdkosten FromJson(string json) => JsonConvert.DeserializeObject<Fremdkosten>(json, BO4EDotNet.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Fremdkosten self) => JsonConvert.SerializeObject(self, BO4EDotNet.Converter.Settings);
    }
