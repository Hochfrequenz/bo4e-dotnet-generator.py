    ...
    for root, _, files in os.walk(directory_path):
        for filename in files:
            if filename.endswith(".cs"):
                ...
                classes_to_remove = [
                    class_name for class_name in classes_in_file
                    if class_name != class_name_from_filename
                ]
                enums_to_remove = [
                    enum_name for enum_name in enums_in_file
                ]

                for class_name in classes_to_remove:
                    class_file_path_bo = os.path.join(directory_path, 'bo', f'{class_name}.cs')
                    class_file_path_com = os.path.join(directory_path, 'com', f'{class_name}.cs')
